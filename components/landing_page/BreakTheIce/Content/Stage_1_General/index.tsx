...
const General: FunctionComponent<MUIStyledCommonProps> = (props) => {
    return (
        <>
            ...
            <SingleLanguage name="Polish" stars={5} description="Native speaker" />
            <SingleLanguage name="English" stars={4} description="Between B2 and C1, learn every day" />
            <SingleLanguage name="German" stars={1} description="Eines tages eines tages, uber leider nicht jetzt" />
        </>
    );
};
