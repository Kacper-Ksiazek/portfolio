import { ProjectType, type Project } from "./types";
...
const projects: Project[] = [
    ...
    },
    {
        ...
        features: [
            { title: "Single content element- landing", imageURL: "4_single_content_element_landing" },
            { title: "User profile- landmark reviews", imageURL: "10_landmarks_reviews_on_user_profile" },
            { title: "Your review is always on the top", imageURL: "11_auth_user_review_is_always_on_the_top" },
            ...
            { title: "Create content- description", imageURL: "14_rich_and_highly_customizable_description" },
            ...
            { title: "Single content element- recommendiations", imageURL: "6_single_content_element_recommended landmakrs" },
            { title: "Single content element- newest reviews", imageURL: "7_single_content_element_newest_reviews" },
    ...
    },
    {
        ...
        features: [
            ...
            { title: "Two dataset_comparision- games duration", imageURL: "14_Two dataset_comparison- answers accuration" },
            ...
            { title: "20_Single game summary- only correct answers", imageURL: "20_Single game summary- only correct answers" },
        ],
    },
    {
        id: "OLX_2",
